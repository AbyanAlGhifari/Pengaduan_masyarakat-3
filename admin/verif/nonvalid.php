...
$queryTampil = "SELECT p.id_pengaduan as id_pengaduan, m.nama as nama, p.tgl_pengaduan as tgl_pengaduan, p.foto as foto, p.isi_laporan as isi_laporan, p.status as status FROM pengaduan p JOIN masyarakat m WHERE p.nik = m.nik AND status is NULL;";
...
<head>
    ...
    <title>Pengaduan - NonValid</title>
...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center align-middle">
            <center><h2>List Pengaduan - NonValid</h2></center>
