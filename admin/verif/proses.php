...
if (isset($_GET['id'])) {
    ...
    if ($execQuery) {
        header('Location:/masyarakat_ngadu/admin/verif/proses.php');
    } else {
        echo '<script>alert("ada yang salah")</script>';
    }
}

$queryTampil = "SELECT p.id_pengaduan as id_pengaduan, m.nama as nama, p.tgl_pengaduan as tgl_pengaduan, p.foto as foto, p.isi_laporan as isi_laporan, p.status as status FROM pengaduan p JOIN masyarakat m WHERE p.nik = m.nik AND status = 'proses';";
...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center align-middle">
            <center><h2>List Pengaduan - Proses</h2></center>
